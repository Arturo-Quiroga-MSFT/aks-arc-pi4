...
# pre-pull images needed by kubeadm init (if you want to install the latest version, now is 1.20.1)
kubeadm config images pull

# at the master node do this, to do a dry run first
sudo kubeadm init --dry-run --kubernetes-version=v1.20.1 --pod-network-cidr=192.168.0.0/16
